...
public class AdminLTEController {
    ...
    public String getTablesData(Model model, @RequestParam(value = "pageNum", defaultValue = "0") int pageNum, @RequestParam(value = "pageSize", defaultValue = "2") int pageSize){
        Iterable<Student> studentList = studentManageService.findStudentNoCriteria(pageNum,pageSize);
