...
@Api(tags = {"城市","数据库测试" }, value = "与CITY表交互的controller")
...
//    @ApiImplicitParam(paramType="query", name = "userNumber", value = "用户编号", required = true, dataType = "Integer")
    ...
    @ApiOperation(value="按照主键查找一个城市", notes="获取单条数据")
    ...
    // 分页查询
    @ResponseBody
    @GetMapping(value="/findPageCityOrderByPopulation")
    public Page<City> findPageCityOrderByPopulation(Integer size, Integer page){
        Assert.notNull(size);
        Pageable pageable = PageRequest.of(page,size, Sort.Direction.DESC,"id");
        return cityService.findByPopulationOrderWithPageAble(pageable);
    }
